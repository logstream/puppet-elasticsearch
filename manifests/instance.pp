...
define elasticsearch::instance(
  ...
  if ($ensure == 'present') {
    ...
    $instance_init_defaults_main = { 'CONF_DIR' => $instance_configdir, 'CONF_FILE' => "${instance_configdir}/elasticsearch.yml", 'LOG_DIR' => "/var/log/elasticsearch/${name}", 'ES_HOME' => '/opt/elasticsearch' }
